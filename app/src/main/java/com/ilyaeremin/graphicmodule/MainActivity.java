...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        final ChartView uiChartPreview = findViewById(R.id.chart_preview);
        ...
        final SeekBar uiLeftBound = findViewById(R.id.left_bound);
        ...
        final SeekBar uiRightBound = findViewById(R.id.right_bound);
